...
const AboutSection = ({
  title = "Casa Lulu Tulum",
  description = "Located in Aldea Zama in Tulum, Mexico...",
  image = "https://ik.imagekit.io/peregrinedesign/Website%20Assets/Casa%20Lulu%20Tulum/Main%20Home%20Page%20Photos/Main4.webp",
  welcomeText = "Welcome to your home in Tulum...",
  propertyDetails = [
    "Location: Aldea Zama",
    "Bedrooms: 4",
    "Bathrooms: 3",
  ...
  price = "$1,499,000 USD",
  footerText = "Casa Lulu has been hosting...",
  accentColor = "#df1f29",
  backgroundColor = "#ffffff",
}) => {
  return (
    <main className="ms-container" style={{ backgroundColor }}>
      ...
      <div className="ms-section__block">
        <div id="about" className="row">
          <div className="about__img col-md-12">
            <p>
              <img src={image} alt="About property" />
            </p>
          </div>

          <div className="center-block">
            <div className="about__info col-md-8">
              <p className="about-title" style={{ color: accentColor }}>
                welcome
              </p>
